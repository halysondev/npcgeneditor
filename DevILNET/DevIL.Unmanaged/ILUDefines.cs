...
public static class ILUDefines
{
	...
	public const int ILU_ENGLISH = 2048;

	public const int ILU_ARABIC = 2049;

	public const int ILU_DUTCH = 2050;

	public const int ILU_JAPANESE = 2051;

	public const int ILU_SPANISH = 2052;

	public const int ILU_GERMAN = 2053;

	public const int ILU_FRENCH = 2054;
}
